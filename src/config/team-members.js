const teamMembers = {
      ...
      contact: [
        {
          ...
          type: 'Slack',
          body: 'chrisvfritz',
          url: 'http://slack.lansing.codes/'
        }, {
          type: 'Email',
          body: 'chrisvfrit@gmail.com',
          url: 'mailto:chrisvfrit@gmail.com'
        }
      ]
    }, {
      name: 'Jesse Flores',
      ...
      contact: [
        {
          type: 'GitHub',
          body: 'jflores1',
          url: 'https://github.com/jflores1'
        }, {
          type: 'Twitter',
          body: 'jflores1c',
          url: 'https://twitter.com/jflores1c'
        }, {
          type: 'LinkedIn',
          body: 'jafloresjr',
          url: 'https://www.linkedin.com/in/jafloresjr'
        }
      ]
    }
  ],
      ...
      contact: [
        {
          ...
          url: 'mailto:NickRutowski@gmail.com'
        }
      ]
    }
  ],
  mentors: [
    {
      name: 'Erik Gillespie',
      bio: "I'm is a professional juggler of coding, board gaming, writing, parenting, and businessing. The coding happens at <a href=\"http://vertafore.com/\">Vertafore</a>, board gaming with anyone who says yes, writing on <a href=\"http://geekandsundry.com/author/erikgillespie/\">Geek & Sundry</a>, evidence of parenting is on my <a href=\"http://gillespieproject.com/\">blog</a>, and I business at <a href=\"http://technicalrex.com/\">Technical Rex</a>.",
      tech: "Anything and everything Java. JavaScript both client- and server-side, SQL, shell scripting (including just getting around the terminal). More abstract things such as how the Internet works and REST. I think some not-coding-but-handy-for-coders things like Inkscape and Gimp (since they're free), agile concepts, unit testing (TDD even), and application security. If you're looking for more specific answers I can break any of these down for you.",
      contact: [
        {
          type: 'GitHub',
          body: 'egillespie',
          url: 'https://github.com/egillespie'
        }, {
          type: 'Email',
          body: 'erik.gillespie@gmail.com',
          url: 'mailto@erik.gillespie@gmail.com'
        }, {
          type: 'Stack Overflow',
          body: 'erik-gillespie',
          ...
          type: 'LinkedIn',
          body: 'eriklgillespie',
          url: 'https://www.linkedin.com/in/eriklgillespie'
        }, {
          type: 'Twitter',
          body: 'eriklgillespie',
          url: 'https://twitter.com/eriklgillespie'
        }, {
          type: 'Blog',
      ...
      contact: [
        {
          type: 'GitHub',
          body: 'kieraw',
          url: 'https://github.com/kieraw'
        }, {
          type: 'LinkedIn',
          body: 'kiera-wheatley',
          url: 'https://www.linkedin.com/pub/kiera-wheatley/a2/1a9/1b1'
        }
      ]
    }, {
      ...
      contact: [
        {
          type: 'GitHub',
          body: 'icy-wolf',
          url: 'https://github.com/icy-wolf'
        }, {
          type: 'Email',
          body: 'nicole.lawrence93@gmail.com',
          url: 'mailto:nicole.lawrence93@gmail.com'
        }
      ]
    }, {
      name: 'Stuart Pearman',
      ...
      contact: [
        {
          type: 'GitHub',
          body: 'stuartpearman',
          url: 'https://github.com/stuartpearman'
        }, {
          type: 'Email',
          body: 'swpearman@gmail.com',
          url: 'mailto:swpearman@gmail.com'
        }
      ]
    }
  ]
